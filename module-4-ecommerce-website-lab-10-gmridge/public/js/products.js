class Products{
    ...
    getSingleProduct(id) {
        $.ajax({
            ...
            success: function (data) {
                $('.breadcrumb').html('<a href="/">Home</a><span class="sep"></span><a href="/category.html?category=' + data.category +'">' + toTitleCase(data.category) +'</a><span class="sep" </span>' + data.title)
